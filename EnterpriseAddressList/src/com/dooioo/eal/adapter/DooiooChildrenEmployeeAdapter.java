...
public class DooiooChildrenEmployeeAdapter extends BaseAdapter
{

	private final String TAG = "DooiooChildrenEmployeeAdapter";
	Context context;
	private List<Employee> list;

	public DooiooChildrenEmployeeAdapter(Context context, List<Employee> list)
	{
...
//					.findViewById(R.id.ll_item);
		...
		holder.tv.setText(getItem(position).userNameCn);
