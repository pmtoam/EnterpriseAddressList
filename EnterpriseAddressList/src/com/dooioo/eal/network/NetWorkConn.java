...
//											+ "  " + resp.emps.get(i).userTitle);
								...
								Log.e(TAG, "ºÄÊ± = " + (System.currentTimeMillis() - last) / 1000);
							};
						}.start();	
					}
				}
		...
		DAsyncTaskRequest<EmployeeGet> dAsyncTaskRequest = new DAsyncTaskRequest<EmployeeGet>(null, dRequest, type, false, null);
		dAsyncTaskRequest.execute(new DHttpRequest("POST", getAllEmployeesUrl, null));	
	}
